...
shared/rns/                 Protocol implementation (transport-agnostic)
  ...
  propagation.js                LXMF propagation nodes: store-and-forward (upload/download interoperate with real LXMRouter — see Compliance)
